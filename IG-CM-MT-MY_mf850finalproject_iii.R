######### MF850 Final Project Question iii ###########
####
#### 12/20/2016
####
...
RandomForestCatFile <- "random_forest_cat.R"
...
# 1 means stock price will go up, 0 means stock price will go down
categoricalStockPredictions <- function(df) {
  ...
  rf_cat_model <- readRDS(RandomForestCatModelFile)
...
stockPredictions <- categoricalStockPredictions(df)
